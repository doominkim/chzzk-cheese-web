...
export default function NaverLoginView() {
  ...
  useEffect(() => {
    const processNaverLogin = async () => {
      ...
      const params = {};
      // console.log(window.location); //Location {ancestorOrigins: DOMStringList, href: 'http://52.78.41.110/auth/naverLogin#access_token…57-eb93287b5f70&token_type=bearer&expires_in=3600', origin: 'http://52.78.41.110', protocol: 'http:', host: '52.78.41.110', …}
      ...
      try {
        ...
        const response = await axios.post(
          `http://52.78.41.110/auth/login/naver?accessToken=${params.access_token}`
        );
